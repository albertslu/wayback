  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-cyan-50">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12">
      ...
      <div className="max-w-lg mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/30 p-6 md:p-8 mb-12">
        ...
        {/* Call to Action */}
        <div className="text-center bg-gradient-to-r from-indigo-600/10 to-cyan-600/10 rounded-2xl p-8 border border-indigo-200/20">
